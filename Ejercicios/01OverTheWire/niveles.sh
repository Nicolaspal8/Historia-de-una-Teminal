**Nivel 1 =
coneccion ssh con un puerto en especifico
ssh nombreUser@host -p nuevo_port
...
**En este punto nos piden buscar un archivo con ciertas caracteristicas que solo sea humanamente legible por ende sabiendo esto podemos buscar entre muchos archivos y filtrar por los que poseen esas caracteristicas
